...
define([], function () {
    ...
    return function () {
        ...
        function viewerFunc() {
            ...
            if (typeof window.__CKEditorViewer_0_1 === 'undefined') {

                if (typeof window.CKEditorViewer === 'undefined') {
                ...
                window.__CKEditorViewer_0_1 = true;
            }

            return window.__CKEditorViewer_0_1;
